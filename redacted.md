...
![Sliding Window Attention and Effective Context Length diagrams](page_320_370_1000_300.png)
...
![A diagram showing the attention mask for pre-fill and chunking, with a table of attention values for the words "the cat sat on the mat and saw the dog go to" broken into past, cache, and current windows.](page_370_670_808_246.png)
...
[10] Karl Cobbe, Vineet Kosaraju, Mohammad Bavarian, Mark Chen, Heewoo Jun, Lukasz Kaiser, Matthias Plappert, Jerry Tworek, Jacob Hilton, Reichi Nakano, et al. Training verifiers to solve math word problems. arXiv preprint arXiv:2110.14168, 2021.
...
[26] Hugo Touvron, Louis Martin, Kevin Stone, Peter Albert, Amjad Almahairi, Yasmine Babaei, Nikolay Bashlykov, Soumya Batra, Prajwol Bhargava, Shruti Bhosale, et al. Llama 2: Open foundation and fine-tuned chat models. arXiv preprint arXiv:2307.09288, 2023.
